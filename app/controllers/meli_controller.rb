# This two gems are important,
# JSON for parsing the response of the query and
# MELI for loading the MercadoLibre's Ruby SDK
require 'json'
require 'meli'
# The actual controller for making the call
class MeliController < ApplicationController
  def meli
    # Let's do a query, first of all,
    # we need something to look for, so we're going to get the input of the form
    # located at index#index.html.erb
    ...
    meli = Meli.new(
      134_732_994_446_482_8,
      'NSlACWY5RtCDSJgi1AHcQBbU1054EQnt'
    )
